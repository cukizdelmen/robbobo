...
const Categories = () => {
  const { categories, fetchCategories, createCategory, deleteCategory, updateCategory, uploadCategoryImage } = useData();

  const [modalOpen, setModalOpen] = useState(false);
  const [isEditmodalOpen, setIsEditModalOpen] = useState(false);
  const [loading, setLoading] = useState(false);
  const [showConfirmModal, setShowConfirmModal] = useState(false);
  const [selectedCategoryToDelete, setSelectedCategoryToDelete] = useState<number | null>(null);
  ...
  const handleCreateCategory = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      if (newCategoryData.Name.trim() === "" || newCategoryData.slug.trim() === "" || !newCategoryData.imageFile) {
          ...
          <div className={styles.categoryBox}>
            {categories.map((category: Category) => (
              <div key={category.id} className={styles.categoryItem}>
                <img className={styles.categoryImage} src={category.image_url}/>
                <span className={styles.categoryName}>{category.Name}</span>
                <div className={styles.catButtons}>
                  <button onClick={() => handleisEditModalOpen(category)} className={styles.catEditButtons}>Edit</button>
                  <button onClick={() => handleDeleteCategoryClick(category.id)} className={styles.catDeleteButtons}>Delete</button>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className={styles.categoryModal}>
            ...
            <div className={styles.modalContant}>
              ...
              <form className={styles.categoryForm} onSubmit={handleCreateCategory}>
                ...
                <div className={styles.categoryInputGroup}>
                  <label className={styles.categoryInputLabel} htmlFor="description">
                    Description
                  </label>
                  <input
                    className={styles.categoryInput}
                ...
                <div className={styles.categoryInputGroup}>
                  <label className={styles.categoryInputLabel} htmlFor="imageFile">
                    Cover Image
                  </label>
                  <input
                    className={styles.categoryInput}
                    type="file"
                    name="imageFile"
                    onChange={(e) => setNewCategoryData({...newCategoryData, imageFile: e.target.files?.[0] || null})}
                    required
                  />
                </div>
                <button className={styles.categorySave} type="submit" disabled={loading}>
                  {loading ? "Saving..." : "Save"}
                </button>
              </form>
            </div>
        ...
        {isEditmodalOpen && (
          <div className={styles.categoryModal}>
            ...
            <div className={styles.modalContant}>
              ...
              <form className={styles.categoryForm} onSubmit={handleEditCategory}>
                <div className={styles.categoryInputGroup}>
                  <label className={styles.categoryInputLabel} htmlFor="Name">
                    Name
                  </label>
                ...
                <div className={styles.categoryInputGroup}>
                  ...
                  <input 
                    ...
                    onChange={(e) => setEditedCategoryData({...editedCategoryData, slug: e.target.value})}
                  />
                </div>
                <div className={styles.categoryInputGroup}>
                  <label className={styles.categoryInputLabel} htmlFor="description">
                ...
                <div className={styles.categoryInputGroup}>
                  ...
                  <input 
                    ...
                    type="file" 
                    name="imageFile"
                    onChange={(e) => setEditedCategoryData({...editedCategoryData, imageFile: e.target.files?.[0] || null})}
                  />
                </div>
                <button className={styles.categorySave} type="submit" disabled={loading}>
                  {loading ? "Saving..." : "Save"}
          ...
          <div className={styles.categoryModal}>
            <div className={styles.confirmModalContent}>
              ...
              <div className={styles.confirmButtons}>
                <button onClick={confirmDelete} className={styles.confirmYes}>Yes</button>
                <button onClick={cancelDelete} className={styles.confirmNo}>No</button>
              </div>
            </div>
          </div>
        )}
